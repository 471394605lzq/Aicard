    ...
    public static class Config
    {
        ...
        public static string PrivateKeyPath
        {
            get
            {
                ...
                {
                    privateKeyPath = HttpContext.Current.Server.MapPath("~/App_Start/TxIm/private_key");
                }
        ...
        public static string PublicKeyPath
        {
            get
            {
                if (string.IsNullOrWhiteSpace(privateKeyPath))
                {
                    publicKeyPath = HttpContext.Current.Server.MapPath("~/App_Start/TxIm/public_key");
                }
        ...
        /// SdkAppId 腾讯云里面查看
        /// </summary>
        public const int SdkAppId = 1400157072;
        /// <summary>
        /// 腾讯云里面定于的admin帐号
        /// </summary>
        ...
        public static string Sign
        {
            get
            {
                ...
                {
                    sign = System.IO.File.ReadAllText(HttpContext.Current.Server.MapPath("~/App_Start/TxIm/sig"));
                }
                return sign;
            }
        }
