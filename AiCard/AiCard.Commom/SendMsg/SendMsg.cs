...
namespace AiCard.Commom.SendMsg
{
    enum EBodyType : uint
    {
        EType_XML = 0,
    ...
    {
        private string m_restAddress = "api.ucpaas.com";
        private string m_restPort = "443";
        private string m_mainAccount = "313de8c982b0f1a0a23df70f9c10b900";
        private string m_mainToken = "14d3b4a2f3606f30d705bf3a626e2b9d";
        private string m_appId = "c87f5863930e4246908e6278336a09b2";
        private bool m_isWriteLog = false;


        //private string baseUrl = "https://api.ucpaas.com:443";
        //private string accountSid = "313de8c982b0f1a0a23df70f9c10b900";//Account Sid，用户申请
        //private string token = "14d3b4a2f3606f30d705bf3a626e2b9d";//同上
        //private string appId = "c87f5863930e4246908e6278336a09b2";//注册获得的应用程序Id
